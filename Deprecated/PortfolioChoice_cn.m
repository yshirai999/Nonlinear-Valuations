...
bnvec = [0.0521, 0.0521].*Emat;
cnvec = [linspace(1,30,N)', 6.1102*E];
...
ylabel('$\theta_*(c_n)$', 'Interpreter', 'latex')
xlabel('$$\mu/\sigma$$', 'Interpreter', 'latex')
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlcn_Sharpe');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlcn_mun');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlcn_sigman');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
box on
plot(bnvec(:,1),theta(:,1))
ylabel('$\theta_*(b_n)$','Interpreter','latex')
xlabel('$b_n$', 'Interpreter', 'latex')
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlbn_bn');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlbn_Sharpe');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlbn_mun');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
set(gca,'TickLabelInterpreter','latex')
fpath=('C:\Users\Yoshihiro Shirai\Desktop\PhD\Research\CDXO Nonlinear Valuation');
str=strcat('OptimalControlbn_sigman');
fname=str;
saveas(gcf, fullfile(fpath, fname), 'epsc');
hold off
...
function mtilde = VGkappa(y,D,b,v,Sigmainv,detSigma) %y is D x N
    mtilde = ( exp(b'*Sigmainv*y)' ./ ( v*(2*pi)^(D/2-1)*sqrt(abs(detSigma))*sqrt(diag((y'*Sigmainv)*y)) ) ).*...
            besselk(D/2,-sqrt( (b'*Sigmainv*b+2/v)*(diag(y'*Sigmainv*y))));
end
