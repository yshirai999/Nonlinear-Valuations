...
try
    SPYMD = load(strcat('SPYMD',num2str(SY),'DM',num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N))); SPYMD = SPYMD.SPYMD;
    RC = load(strcat('RC',num2str(SY),'DM',num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N))); RC = RC.RC;
    mu_mod = load(strcat('mu_modDM',num2str(SY),num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N))); mu_mod = mu_mod.mu_mod;
    mu_mkt = load(strcat('mu_mkt',num2str(SY),num2str(Delta),num2str(N))); mu_mkt = mu_mkt.mu_mkt;
    err = load(strcat('errDM',num2str(SY),num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N))); err = err.err;
...
if strcmp(s,'Y')
    ...
    s = input(prompt, 's');
    if strcmp(s,'Y')
        save(strcat('SPYMD',num2str(SY),'DM',num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N)),'SPYMD');
        save(strcat('RC',num2str(SY),'DM',num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N)),'RC');
        save(strcat('mu_modDM',num2str(SY),num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N)),'mu_mod');
        %save(strcat('mu_mktDM',num2str(SY),num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N)),'mu_mkt');
        save(strcat('ErrDM',num2str(SY),num2str(Delta),num2str(enforcegamma),num2str(enforceb),num2str(N)),'err');
    end
end
