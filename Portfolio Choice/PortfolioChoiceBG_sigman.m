...
if strcmp(Ej,'pos')
    ...
    mun = [mun,mun].*Emat;
    sigman = [linspace(0.005,0.05,N)',sigman*E];
    ...
    sigmap = [sigmap, sigmap].*Emat;
    mun = [mun,mun].*Emat;
    sigman = [linspace(0.005,0.9,N)',sigman*E];
...
if vis == 1
    ...
    str=strcat('OptimalControlBGsigmn_Sharpe',Ej);
    fname=str;
    ...
    set(gca,'TickLabelInterpreter','latex')
    str=strcat('OptimalControlBGsigman_sigman',Ej);
    fname=str;
    saveas(gcf, fullfile(vizPath, fname), 'pdf');
    hold off
end 
