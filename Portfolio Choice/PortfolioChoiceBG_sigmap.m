...
if strcmp(Ej,'pos')
    ...
    Emat = [E,E];
    mup = [mup, mup].*Emat;
    sigmap = [[linspace(0.001,0.03,N/2),linspace(0.03,0.3,N/2)]', sigmap*E];
    mun = [mun,mun].*Emat;
    ...
    Emat = [E,E];
    mup = [mup, mup].*Emat;
    sigmap = [[linspace(0.0001,0.03,N/2),linspace(0.03,0.4,N/2)]', sigmap*E];
    mun = [mun,mun].*Emat;
    sigman = [sigman,sigman].*Emat;
...
function d = dpsin(x,c,b)
    d = b*exp( -c * x );
end
 
function d = dpsip(x,c,gamma,a)
    d = (a*c/(1+gamma))...
